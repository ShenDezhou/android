...
public class MyItemAnimator extends RecyclerView.ItemAnimator {
	...
	private static class MoveInfo {
		...
		private MoveInfo(ViewHolder holder, int fromX, int fromY, int toX,
				int toY) {
			this.holder = holder;
			this.fromX = fromX;
			this.fromY = fromY;
	...
	private static class ChangeInfo {
		...
		public String toString() {
			return "ChangeInfo{" + "oldHolder=" + oldHolder + ", newHolder="
					+ newHolder + ", fromX=" + fromX + ", fromY=" + fromY
					+ ", toX=" + toX + ", toY=" + toY + '}';
		}
	}
	...
	public boolean animateAdd(final ViewHolder holder) {
		endAnimation(holder);
		ViewCompat
				.setTranslationX(holder.itemView, -holder.itemView.getWidth());
	...
	public boolean animateChange(ViewHolder oldHolder, ViewHolder newHolder,
		...
		mPendingChanges.add(new ChangeInfo(oldHolder, newHolder, fromX, fromY,
				toX, toY));
		return true;
	}
	...
	private void animateChangeImpl(final ChangeInfo changeInfo) {
		...
		if (view != null) {
			final ViewPropertyAnimatorCompat oldViewAnim = ViewCompat.animate(
					view).setDuration(getChangeDuration());
		...
		if (newView != null) {
			final ViewPropertyAnimatorCompat newViewAnimation = ViewCompat
					.animate(newView);
			mChangeAnimations.add(changeInfo.newHolder);
			newViewAnimation.translationX(0).translationY(0)
					.setDuration(getChangeDuration()).alpha(1)
					.setListener(new VpaListenerAdapter() {
						@Override
						public void onAnimationStart(View view) {
	...
	public boolean isRunning() {
		return (!mPendingAdditions.isEmpty() || !mPendingChanges.isEmpty()
				...
				|| !mMovesList.isEmpty() || !mAdditionsList.isEmpty() || !mChangesList
					.isEmpty());
	}
